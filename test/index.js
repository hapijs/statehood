...
describe('Statehood', function () {
        ...
        describe('cases', function () {
            ...
            var fail = function (header, settings, definitions, result) {
                ...
                it('fails parsing cookie header: ' + header, function (done) {
                    ...
                    Statehood.parse(request, function (err) {
    ...
    describe('#format', function () {
        ...
        var format = function (cookies, definition, callback) {
            ...
            Statehood.format(cookies, server, callback);
        };

        it('skips an empty header', function (done) {

            format(null, null, function (err, header) {
        ...
        it('skips an empty array', function (done) {
            ...
            format([], null, function (err, header) {
        ...
        it('formats a header', function (done) {
            ...
            format({ name: 'sid', value: 'fihfieuhr9384hf', options: { ttl: 3600, isSecure: true, isHttpOnly: true, path: '/', domain: 'example.com' } }, null, function (err, header) {
        ...
        it('formats a header (with null ttl)', function (done) {
            ...
            format({ name: 'sid', value: 'fihfieuhr9384hf', options: { ttl: null, isSecure: true, isHttpOnly: true, path: '/', domain: 'example.com' } }, null, function (err, header) {
        ...
        it('formats a header with null value', function (done) {
            ...
            format({ name: 'sid', options: { ttl: 3600, isSecure: true, isHttpOnly: true, path: '/', domain: 'example.com' } }, null, function (err, header) {
        ...
        it('formats a header with server definition', function (done) {
            ...
            format({ name: 'sid', value: 'fihfieuhr9384hf' }, definitions, function (err, header) {
        ...
        it('formats a header with server definition (base64json)', function (done) {
            ...
            format({ name: 'sid', value: { a: 1, b: 2, c: 3 } }, definitions, function (err, header) {
        ...
        it('fails on a header with server definition and bad value (base64json)', function (done) {
            ...
            format({ name: 'sid', value: bad }, definitions, function (err, header) {
        ...
        it('formats a header with server definition (form)', function (done) {
            ...
            format({ name: 'sid', value: { a: 1, b: 2, c: '3 x' } }, definitions, function (err, header) {
        ...
        it('fails on bad cookie name', function (done) {
            ...
            format({ name: 's;id', value: 'fihfieuhr9384hf', options: { isSecure: true, isHttpOnly: false, path: '/', domain: 'example.com' } }, null, function (err, header) {
        ...
        it('allows bad cookie name in loose mode', function (done) {
            ...
            Statehood.format({ name: 's;id', value: 'fihfieuhr9384hf', options: { isSecure: true, isHttpOnly: false, path: '/', domain: 'example.com' } }, server, function (err, header) {
        ...
        it('fails on bad cookie value', function (done) {
            ...
            format({ name: 'sid', value: 'fi"hfieuhr9384hf', options: { isSecure: true, isHttpOnly: false, path: '/', domain: 'example.com' } }, null, function (err, header) {
        ...
        it('allows bad cookie value in loose mode', function (done) {
            ...
            var server = { _stateDefinitions: null, settings: Hoek.clone(Defaults.server) };
            server.settings.state.cookies.strictHeader = false;
            Statehood.format({ name: 'sid', value: 'fi"hfieuhr9384hf', options: { isSecure: true, isHttpOnly: false, path: '/', domain: 'example.com' } }, server, function (err, header) {
        ...
        it('fails on bad cookie domain', function (done) {
            ...
            format({ name: 'sid', value: 'fihfieuhr9384hf', options: { isSecure: true, isHttpOnly: false, path: '/', domain: '-example.com' } }, null, function (err, header) {
        ...
        it('fails on too long cookie domain', function (done) {
            ...
            format({ name: 'sid', value: 'fihfieuhr9384hf', options: { isSecure: true, isHttpOnly: false, path: '/', domain: '1234567890123456789012345678901234567890123456789012345678901234567890.example.com' } }, null, function (err, header) {
        ...
        it('formats a header with cookie domain with . prefix', function (done) {
            ...
            format({ name: 'sid', value: 'fihfieuhr9384hf', options: { isSecure: true, isHttpOnly: false, path: '/', domain: '.12345678901234567890.example.com' } }, null, function (err, header) {
        ...
        it('fails on bad cookie path', function (done) {
            ...
            format({ name: 'sid', value: 'fihfieuhr9384hf', options: { isSecure: true, isHttpOnly: false, path: 'd', domain: 'example.com' } }, null, function (err, header) {
